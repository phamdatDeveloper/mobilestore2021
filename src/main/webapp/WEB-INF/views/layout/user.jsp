...
<link rel="shortcut icon" type="image/x-icon"
	href="<c:url value ="/template/user/images/favicon.png"/>">
<!-- Material Design Iconic Font-V2.2.0 -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/material-design-iconic-font.min.css"/>  ">
<!-- Font Awesome -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/font-awesome.min.css"/> ">
<!-- Font Awesome Stars-->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/fontawesome-stars.css"/> ">
<!-- Meanmenu CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/meanmenu.css"/> ">
<!-- owl carousel CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/owl.carousel.min.css"/> ">
<!-- Slick Carousel CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/slick.css"/> ">
<!-- Animate CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/animate.css"/> ">
<!-- Jquery-ui CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/jquery-ui.min.css"/> ">
<!-- Venobox CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/venobox.css"/> ">
<!-- Nice Select CSS -->
<link rel="stylesheet"
...
<!-- Helper CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/helper.css"/> ">
<!-- bootoast -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/bootoast.css"/> ">
<!-- Main Style CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/style.css"/> ">
<!-- Responsive CSS -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/responsive.css"/> ">
<!-- Modernizr js -->
<script
	src="<c:url value ="/template/user/js/vendor/modernizr-2.8.3.min.js"/>"></script>
<!-- Sweet alert -->
<link rel="stylesheet"
	href="<c:url value ="/template/user/css/sweetalert2.min.css"/>">
...
<body>
	...
	<!-- Meanmenu js -->
	<script
		src="<c:url value ="/template/user/js/jquery.meanmenu.min.js"/>"></script>
	<!-- Wow.min js -->
	...
	<!-- Imagesloaded js -->
	<script
		src="<c:url value ="/template/user/js/imagesloaded.pkgd.min.js"/>"></script>
	<!-- Mixitup js -->
	...
	<!-- Counterup -->
	<script
		src="<c:url value ="/template/user/js/jquery.counterup.min.js"/>"></script>
	<!-- Waypoints -->
	<script src="<c:url value ="/template/user/js/waypoints.min.js"/>"></script>
	<!-- Barrating -->
	<script
		src="<c:url value ="/template/user/js/jquery.barrating.min.js"/>"></script>
	<!-- Jquery-ui -->
