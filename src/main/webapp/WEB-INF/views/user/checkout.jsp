...
<body>
	...
	<div class="checkout-area pt-60 pb-30">
		<div class="container">
	<form:form action="/checkout" modelAttribute="formCheckout" id="checkout-form"  method="post" >
			<div class="row">
						...
						<div class="checkbox-form">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<form:errors path="statusPay" class="error" />	
									<div class="row">
										<div class="col-6"><button id="btn-shipcod" onclick="setShipStatus('COD')" type="button" class="btn">Thanh toán khi nhận hàng</button></div>
										<div class="col-6"><button id="btn-paypal" type="button" class ="btn">Thanh toán bằng Paypal</button></div>
									</div>
									
										<form:input  type="hidden" path="statusPay" id="status" tabindex="1" class="form-control" placeholder="" />
							...
							<table class="table">
									...
									<c:forEach items="${carts }" var="cart">
										<tr class="cart_item">
											<td class="cart-product-name">
												<div class="row">
													<div class="col-3">
														<img width="50px" height="50px" src="<c:url value="${cart.value.product.mainImage}"/>" alt="cart products">
													</div>
													<div class="col-9">
								...
								<tfoot>
									...
									<tr class="order-total">
										...
										<td><strong><span class="amount"><fmt:formatNumber type="number" maxFractionDigits="3" value="${totalPrice}" /> đ</span></strong></td>
									</tr>
								</tfoot>
							</table>
						</div>
