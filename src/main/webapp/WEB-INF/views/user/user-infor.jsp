            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-8 col-xs-8">
                       <form:form action="/user" id="register-form" modelAttribute="formEditUser" method="get">>
                            <div class="login-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-20">
										...
										tabindex="1" class="mb-0" placeholder="Email" disabled="true"  />
                                    </div>
                                    <div class="col-md-12 mb-20">
                                        <label>Địa chỉ*</label>
                                    ...
                                    <div class="col-3">
                                        <a href="my-account.html" class="text-center register-a mt-0">Hủy</a>
                                    </div>
                                </div>
                            </div>
                        </form:form>
