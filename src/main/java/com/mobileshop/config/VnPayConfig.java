...
public class VnPayConfig {
	...
	public static String vnp_TmnCode = "VFB33LCZ";
	public static String vnp_HashSecret = "UGOUNTBSFVYMREMNMFWNUYMZGMZZWVRF";
	...
	public static String hashAllFields(Map fields) throws UnsupportedEncodingException {
		...
		sb.append(com.mobileshop.config.VnPayConfig.vnp_HashSecret);
